...
export const Desktop = (): JSX.Element => {
  ...
  const [isRozvrhModalOpen, setIsRozvrhModalOpen] = useState(false);
  ...
  return (
    <div className="relative w-full min-h-screen bg-[#c0d1d8] overflow-hidden">
      ...
      {isRozvrhModalOpen && (
        ...
        >
          <div
            className="bg-[#fffcf9] max-w-6xl w-full max-h-[90vh] overflow-y-auto rounded-lg relative"
            onClick={(e) => e.stopPropagation()}
          >
            <div className="p-12">
              <Button
              ...
              <h1 className="[font-family:'Public_Sans',Helvetica] font-bold text-black text-5xl tracking-[0] leading-[normal] mb-8">
                Rozvrh pro meetingovku
              </h1>

              <div className="flex flex-col md:flex-row gap-8 mb-8">
                <div className="flex-1">
                  <p className="[font-family:'Public_Sans',Helvetica] font-normal text-black text-xl tracking-[0] leading-[31px] mb-6">
                    V rámci 3 denního školního projektu ve spolupráci s Fablab
                    Brno a AT&T jsme měli za úkol vyřešit problém s bookováním
                    meetingových místností. Měli jsme k dispozici E-ink display,
                    arduino uno a jednoduchou elektroniku. Na tomto projektu
                    jsme pracovali v tymech a měl simulovat reálné problémy v
                    práci.
                  </p>
                </div>
                <div className="flex-shrink-0">
                  <img
                    className="w-full md:w-[200px] h-auto max-h-[40vh] object-contain rounded mr-6"
              ...
              <div className="flex flex-col md:flex-row gap-8 mb-8">
                ...
                <div className="flex-1">
                  <p className="[font-family:'Public_Sans',Helvetica] font-normal text-black text-xl tracking-[0] leading-[31px] mb-6">
                    Pracovali jsme v prostorách poskytnutých Fablabem Brno v
                    JIC, které jsou vybaveny moderní technologií potřebnou k
                    realizaci různých projektů až už pro nadšence nebo
                    startupové firmy.
                  </p>
                  <p className="[font-family:'Public_Sans',Helvetica] font-normal text-black text-xl tracking-[0] leading-[31px] mb-6">
                    V průběhu projektu jsme narazili na pár problémů jako
                    delivery pro E-ink display nebo samotné programování
                    rozvrhu. K realizování bylo za potřebí kreativity a rychlé
                    řešení problémů v krátkém časovém okně. Kvůli zmíněným
                    časovým limitacím jsem zvolil řešení pomocí kalendáře
                    rozvrženého na hodiny pro daný den a interface se dvěma
                    tlačítky.
                  </p>
                  <p className="[font-family:'Public_Sans',Helvetica] font-normal text-black text-xl tracking-[0] leading-[31px]">
                    Tento projekt byl za mě špatně uplatnén (na všeobecném
                    gymnáziu), protože z celé třídy jsme věděli dopředu co a jak
                    to chceme udělat pouze v několik pokynů.
                  </p>
                </div>
              </div>
            </div>

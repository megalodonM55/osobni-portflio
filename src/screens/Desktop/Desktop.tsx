          ...
          >
            <div className="p-12">
              ...
              <div className="flex flex-col md:flex-row gap-8 mb-8">
                <div className="flex-1">
                  <p className="[font-family:'Public_Sans',Helvetica] font-normal text-black text-xl tracking-[0] leading-[31px] mb-6">
                    V rámci 3 denního školního projektu ve spolupráci s Fablab Brno a
                    AT&T jsme měli za úkol vyřešit problém s bookováním meetingových
                    místností. Měli jsme k dispozici E-ink display, arduino uno a
                    jednoduchou elektroniku. Na tomto projektu jsme pracovali v tymech
                    a měl simulovat reálné problémy v práci.
                  </p>
                </div>
                <div className="flex-shrink-0">
                  <img
              ...
              <div className="flex flex-col md:flex-row gap-8 mb-8">
                ...
                <div className="flex-1">
                  <p className="[font-family:'Public_Sans',Helvetica] font-normal text-black text-xl tracking-[0] leading-[31px] mb-6">
                    Pracovali jsme v prostorách poskytnutých Fablabem Brno v JIC,
                    které jsou vybaveny moderní technologií potřebnou k realizaci
                    různých projektů až už pro nadšence nebo startupové firmy.
                  </p>
                  <p className="[font-family:'Public_Sans',Helvetica] font-normal text-black text-xl tracking-[0] leading-[31px] mb-6">
                    V průběhu projektu jsme narazili na pár problémů jako delivery
                    pro E-ink display nebo samotné programování rozvrhu. K
                    realizování bylo za potřebí kreativity a rychlé řešení problémů v
                    krátkém časovém okně. Kvůli zmíněným časovým limitacím jsem
                    zvolil řešení pomocí kalendáře rozvrženého na hodiny pro daný
                    den a interface se dvěma tlačítky.
                  </p>
                  <p className="[font-family:'Public_Sans',Helvetica] font-normal text-black text-xl tracking-[0] leading-[31px]">
                    Tento projekt byl za mě špatně uplatnén (na všeobecném gymnáziu),
                    protože z celé třídy jsme věděli dopředu co a jak to chceme
                    udělat pouze v několik pokynů.
                  </p>
                </div>
              </div>
            </div>
